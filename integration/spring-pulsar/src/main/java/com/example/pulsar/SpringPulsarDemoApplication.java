...
public class SpringPulsarDemoApplication {
	...
	@Bean
	ApplicationRunner runner1(PulsarTemplate<Foo> pulsarTemplate) {
	...
	@PulsarListener(subscriptionName = "spring-pulsar-foo-demo-subscription-3", topics = "spring-pulsar-foo-demo-3",
